...
birthdayWishesDiv.addEventListener("click", function () {
  window.open(
    "https://bhartiashisharvind-afk.github.io/BIRTHDAY/BirthdayWishes.html",
    "_blank",
  );
});
...
weatherButton.addEventListener("click", function () {
  window.open("https://bhartiashisharvind-afk.github.io/weatherForcaste/weatherForecast.html", "_blank");
});

const appologise = document.getElementById("hero-image");

appologise.addEventListener("click", function () {
  alert("Apologies, night mode is not available at the moment, will be added soon");
});
